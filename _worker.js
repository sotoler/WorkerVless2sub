...
// 设置优选地址api接口
let addressesapi = [
	'https://workers-text2kv-cv1.pages.dev/jeffip.txt?token=asd123456', //可参考内容格式 自行搭建。
...
let DLS = 8;//速度下限
let addressescsv = [
	'https://workers-text2kv-cv1.pages.dev/result.csv?token=asd123456', //iptest测速结果文件。
];
...
let CMproxyIPs = [
	'proxyip.aliyun.fxxk.dedyn.io:HK','ProxyIP.US.fxxk.dedyn.io:US','ProxyIP.SG.fxxk.dedyn.io:SG','ProxyIP.JP.fxxk.dedyn.io:JP',//匹配节点名, 有HK就分配该ProxyIP域名
]
